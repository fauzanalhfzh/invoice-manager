...
export default function CreateInvoice() {
  const [state, formAction] = useFormState(SaveInvoice, null);
      ...
      <form action={formAction}>
        ...
        <div className="mb-5">
          ...
          <div id="type_product-error" aria-live="polite" aria-atomic="true">
            <p className="mt-2 text-sm text-red-500">{state?.Error?.type_product}</p>
          </div>
        </div>
        <div className="mb-5">
          <label
        ...
        <div className="mb-5">
          ...
          <div id="serial_number-error" aria-live="polite" aria-atomic="true">
            <p className="mt-2 text-sm text-red-500">{state?.Error?.serial_number}</p>
          </div>
        </div>
        <div className="mb-5">
          <label
          ...
          <div id="accessories-error" aria-live="polite" aria-atomic="true">
            <p className="mt-2 text-sm text-red-500">{state?.Error?.accessories}</p>
          </div>
        </div>
        <div className="mb-5">
          <label
